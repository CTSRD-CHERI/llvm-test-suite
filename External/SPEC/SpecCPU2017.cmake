...
macro (speccpu2017_benchmark)
  ...
  if (NOT DEFINED BENCHMARK)
    ...
    elseif (CMAKE_SIZEOF_VOID_P EQUAL 16 AND SIZEOF_LONG_LONG EQUAL 8 AND SIZEOF_LONG EQUAL 8 AND SIZEOF_INT EQUAL 4)
      # Morello/CHERI-RV64 have to pretend to be LP64
      list(APPEND SPEC_COMMON_DEFS "-DSPEC_LP64")
    else ()
