...
extern int (*overlap)(void) ;
extern int (*overlapf)(void) ;
extern int (*overlapx)(void) ;
extern int goverlap(void) ;
extern int goverlapf(void) ;
extern int goverlapx(void) ;
extern int woverlap(void) ;
extern int woverlapf(void) ;
extern int woverlapx(void) ;
